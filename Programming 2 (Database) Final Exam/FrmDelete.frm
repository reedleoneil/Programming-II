...
Private Sub Form_Load()
    Me.Label1.Caption = "Are you sure you want to delete this " + StrConv(Left(FormMain.TabStripRecordSets.SelectedItem.Caption, Len(FormMain.TabStripRecordSets.SelectedItem.Caption) - 1), vbLowerCase) + "?"
End Sub
