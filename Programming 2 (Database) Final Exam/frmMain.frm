...
Begin VB.Form FormMain 
   ...
   ScaleHeight     =   10350
   ScaleWidth      =   20250
   Begin VB.Frame FrameImageSettings 
      ...
      Begin VB.CommandButton CommandCustomer 
         ...
         Width           =   2175
      End
      Begin VB.CommandButton CommandLogo 
         Caption         =   "Logo"
         Height          =   495
         Left            =   120
         TabIndex        =   67
   ...
   Begin MSComDlg.CommonDialog CommonDialog1 
      ...
      _Version        =   393216
   End
   Begin VB.CommandButton CommandNewTransactions 
...
Call CnnctRcrdSt
RcrdSt.Open "SELECT * FROM Customers WHERE CustomerID = '" & Me.Text1(0).Text & "'", Dtbs

Call ImgStrm
If Me.CommonDialog1.FileName = Empty Then
    ImgStream.LoadFromFile App.Path & "\AnonymousCustomer.bmp"
Else
    ImgStream.LoadFromFile Me.CommonDialog1.FileName
End If
RcrdSt.Fields(5).Value = ImgStream.Read
RcrdSt.Update
End Sub
...
With Me.CommonDialog1
        ...
        .FilterIndex = 1
        .ShowOpen
        Me.ImageDefault.Picture = LoadPicture(.FileName)
End With
End Sub
...
RcrdSt.Open "SELECT * FROM Customers WHERE CustomerID = '" & Me.Text1(0).Text & "'", Dtbs
Call ImgStrm
ImgStream.Write RcrdSt.Fields(5).Value
ImgStream.SaveToFile (App.Path & "\Image.bmp"), adSaveCreateOverWrite
Me.ImageDefault.Picture = LoadPicture(App.Path & "\Image.bmp")
...
Call ImgStrm
Call CnnctRcrdSt
RcrdSt.Open "SELECT * FROM AppData WHERE Products = 'ProductID'", Dtbs


ImgStream.Write RcrdSt.Fields(10).Value
ImgStream.SaveToFile (App.Path & "\Image.bmp"), adSaveCreateOverWrite
Me.ImageDefault.Picture = LoadPicture(App.Path & "\Image.bmp")
...
Else
    ...
    Call ImgStrm
    ImgStream.LoadFromFile Me.CommonDialog1.FileName
    RcrdSt.Fields(11).Value = ImgStream.Read
    RcrdSt.Update
End If
End Sub

Private Sub CommandLogo_Click()
With Me.CommonDialog1
        .FileName = Empty
        .DialogTitle = "Select Photos"
        .InitDir = "C:\"
...
Else
    ...
    Call ImgStrm
    ImgStream.LoadFromFile Me.CommonDialog1.FileName
    RcrdSt.Fields(10).Value = ImgStream.Read
    RcrdSt.Update
End If
End Sub
...
Else
    ...
    Call ImgStrm
    ImgStream.LoadFromFile Me.CommonDialog1.FileName
    RcrdSt.Fields(12).Value = ImgStream.Read
    RcrdSt.Update
End If
End Sub
...
Private Sub Form_Load()
    ...
    Call ImgStrm
    ImgStream.Write RcrdSt.Fields(10).Value
    ImgStream.SaveToFile (App.Path & "\AnonymousProduct.bmp"), adSaveCreateOverWrite
    Me.ImageDefault.Picture = LoadPicture(App.Path & "\AnonymousProduct.bmp")
    ...
    If CurrentDate >= Me.LabelBackupDate Then
        ...
        Dtbs.Execute "UPDATE AppData SET BckupDt = '" & DateAdd("d", 7, LstBckupDt) & "', LstBckupDt = '" & Me.LabelSystemDate & "' WHERE Products = 'ProductID'"
        Call SetFrameBackup
    End If
End Sub
...
Private Sub TabStripRecordSets_Click()
    ...
    ElseIf Me.TabStripRecordSets.SelectedItem = "Customers" Then
        Call ImgStrm
        ImgStream.Write RcrdSt.Fields(11).Value
        ImgStream.SaveToFile (App.Path & "\AnonymousCustomer.bmp"), adSaveCreateOverWrite
        Me.ImageDefault.Picture = LoadPicture(App.Path & "\AnonymousCustomer.bmp")
    Else
        Call ImgStrm
        ImgStream.Write RcrdSt.Fields(12).Value
        ImgStream.SaveToFile (App.Path & "\Logo.bmp"), adSaveCreateOverWrite
        Me.ImageDefault.Picture = LoadPicture(App.Path & "\Logo.bmp")
    End If
...
Private Sub DataGridDefault_Click()
    ...
    Else
        ...
        If Me.TabStripRecordSets.SelectedItem = "Customers" Then
            Call CnnctRcrdSt
            RcrdSt.Open "SELECT * FROM Customers WHERE CustomerID = '" & Me.Text1(0).Text & "'", Dtbs
            Call ImgStrm
            ImgStream.Write RcrdSt.Fields(5).Value
            ImgStream.SaveToFile (App.Path & "\Image.bmp"), adSaveCreateOverWrite
            Me.ImageDefault.Picture = LoadPicture(App.Path & "\Image.bmp")
        ElseIf Me.TabStripRecordSets.SelectedItem = "Products" Then
            Call CnnctRcrdSt
            RcrdSt.Open "SELECT * FROM Products WHERE ProductID = '" & Me.Text1(0).Text & "'", Dtbs
            Call ImgStrm
            ImgStream.Write RcrdSt.Fields(9).Value
            ImgStream.SaveToFile (App.Path & "\Image.bmp"), adSaveCreateOverWrite
            Me.ImageDefault.Picture = LoadPicture(App.Path & "\Image.bmp")
        End If
    End If
End Sub
'clicked search
Private Sub DataComboSrchBy_Click(Area As Integer)
    If Area = 0 Then
        Me.DataComboSrchBy.Locked = False
    Else
        Me.DataComboSrchBy.Locked = True
    End If
End Sub
'clicked sort
Private Sub DataComboSrtBy_Click(Area As Integer)
    If Area = 0 Then
        Me.DataComboSrtBy.Locked = False
    Else
        Me.DataComboSrtBy.Locked = True
    End If
End Sub
...
'activate warranty
Private Sub CommandActivateWarranty_Click()
    If Me.TabStripRecordSets.SelectedItem = "Warranties" And Me.Text1(0).Text <> Empty Then
        Call CnnctRcrdSt
        Qry = "SELECT * FROM Warranties WHERE WarrantyID = '" & Me.Text1(0).Text & "'"
        RcrdSt.Open Qry, Dtbs
        Set Me.DataGridDummy.DataSource = RcrdSt
        
        If Me.DataGridDummy.Columns(1).Text = "Active" Then
            
            Qry = "UPDATE Warranties SET Status = 'Activated' WHERE WarrantyID = '" & Me.Text1(0).Text & "'"
            Dtbs.Execute Qry
            ...
            msg = MsgBox("Warranty Activated!", vbInformation, "Activate Warranty")
        Else
            msg = MsgBox("Warranty was already " & Me.DataGridDummy.Columns(1).Text & "!", vbInformation, "Activate Warranty")
        End If
    
       
    Else
        msg = MsgBox("Select a warranty!", vbInformation, "Activate Warranty")
    End If
End Sub
'void warranty
Private Sub CommandVoidWarranty_Click()
    If Me.TabStripRecordSets.SelectedItem = "Warranties" And Me.Text1(0).Text <> Empty Then
        Call CnnctRcrdSt
        Qry = "SELECT * FROM Warranties WHERE WarrantyID = '" & Me.Text1(0).Text & "'"
        RcrdSt.Open Qry, Dtbs
        ...
        If Me.DataGridDummy.Columns(1).Text = "Active" Then
            ...
            Qry = "UPDATE Warranties SET Status = 'Voided' WHERE WarrantyID = '" & Me.Text1(0).Text & "'"
            Dtbs.Execute Qry
            ...
            msg = MsgBox("Warranty Voided!", vbInformation, "Void Warranty")
        Else
            msg = MsgBox("Warranty was already " & Me.DataGridDummy.Columns(1).Text & "!", vbInformation, "Void Warranty")
        End If
    Else
        msg = MsgBox("Select a warranty!", vbInformation, "Void Warranty")
    End If
End Sub
    ...
    If Me.TabStripRecordSets.SelectedItem = "Products" And Me.Text1(0).Text <> Empty Then
        ...
        ElseIf Val(inpt) > 0 Then
            ...
            For x = 1 To Val(inpt)
                ...
                nxtid = Val(Right(FormMain.DataGridDummy.Columns(0).Text, 5)) + 1
        ...
        End If
    Else
        msg = MsgBox("Select a product!", vbInformation, "Add Stocks")
    End If
End Sub
'cmd refresh stocks
...
Private Sub CommandInsert_Click()
    ...
    FormInsert.Text1(0).Text = Val(Right(Me.DataGridDummy.Columns(0).Text, 5)) + 1
...
'>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>New Transaction<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
Private Sub CommandNewTransactions_Click()
    Me.Enabled = False
